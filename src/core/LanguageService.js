...
const translations = {
    ...
    pl: {
        ...
        enterCommandTooltip: "Wpisz komendÄ™ i nacisnij Enter",
        ...
        noFieldsMatch: "âťs Ĺ»adne pola nie pasujÄ… do",
        elementNotFound: "âťs Element o ID nie zostal znaleziony.",
        availableCompletions: "Dostepne uzupelnienia:",
        noCommandsMatch: "âťs Ĺ»adne komendy nie pasujÄ… do",
