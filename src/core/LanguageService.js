...
const translations = {
    en: {
        ...
        functionNodeTooltip: "Function node - contains C# code with IntelliSense for data models",
        ...
        format: "Format",
        formatCodeTooltip: "Auto-format C# code with proper indentation",
    ...
    pl: {
        ...
        functionNodeTooltip: "Węzeł funkcji - zawiera kod C# z IntelliSense dla modeli danych",
        ...
        format: "Formatuj",
        formatCodeTooltip: "Auto-formatuj kod C# z właściwymi wcięciami",
        codeFormatted: "Kod sformatowany pomyślnie! 🎨",
    ...
    de: {
        ...
        functionNodeTooltip: "Funktions-Knoten - enthält C#-Code mit IntelliSense für Datenmodelle",
